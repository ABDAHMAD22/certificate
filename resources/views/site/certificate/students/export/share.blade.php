...
@section('head_meta')
    ...
    <meta property="og:url" content="{{route('certificate.export', ['certificateStudent'=>$certificateStudent->id])}}">
    ...
    <meta name="twitter:url" content="{{route('certificate.export', ['certificateStudent'=>$certificateStudent->id])}}">
...
@section('content')
    <div class="page-container export-cv2 mx-auto">
        <div class="row">
            <div class="col-12">
                <img class="img-fluid d-block cv-img mx-auto" src="{{ Storage::url($certificateStudent->image) }}"
                     alt="image">
            </div>
        </div>
        <div class="row">
            <div class="col-12 d-flex align-items-center buttons">
                <a target="_blank" href="{{ route('certificate.exportPDF', ['certificateStudent'=>$certificateStudent]) }}"

...
@section('head_meta')
    ...
    <meta property="og:url" content="{{route('ads.share', ['ads'=>$ads->id])}}">
...
@section('content')
    <div class="page-container export-cv2 mx-auto">
        @if(is_null($is_completed))
            <div class="mt-2 mb-3 loading-message">
                ...
                <p class="text-info">جاري تصدير الإعلان</p>
            </div>
        @endif
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-12 d-flex align-items-center buttons">
                ...
                <a href="{{route('ads.update', ['ads'=>$ads])}}"
    ...
    <div id="share-modal" class="modal share-modal">
        <h3 class="text-center xmodal-title">شارك الاعلان</h3>
        <p class="text-center mt-3">قم بنسخ رابط الاعلان وشاركه مع المتدرب/ة ليقوم بتحميله بشكل مباشر</p>

        <form action="#" class="form-gray tall-form mt-lg-5">
            <div class="field-has-btn">
                <div class="form-group">
                    <input type="text" id="link_field" class="form-control"
                           value="{{route('ads.share', ['ads'=>$ads])}}"
                           placeholder="الرابط">
                </div><!--form group-->
            ...
            <div class="share-grid">
                ...
                <ul class="share-links list-unstyled" dir="ltr">
                    <li>
                        <a href="https://twitter.com/intent/tweet?url={{ Storage::url($ads_image) }}"
                           target="_blank">
                            <img width="16" src="{{ asset('site/img/twitter-icon.svg') }}" alt="image">
                        </a>
                    </li>
                    <li>
                        <a href="mailto:?subject={{$ads->title}}&amp;body={{ Storage::url($ads_image) }}"
                           target="_blank">
                            <img src="{{ asset('site/img/email-icon.svg') }}" alt="image">
                        </a>
                    </li>
                    <li>
                        <a href="https://wa.me/?text={{ Storage::url($ads_image) }}"
                           target="_blank">

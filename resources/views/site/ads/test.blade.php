        ...
        @if(\App\User::hasAds())
            <form id="adsForm" action="{{route('ads.store')}}" method="POST" class="form-gray tall-form">
                    ...
                    <div class="row templates-row">
                        <div class="col-sm-4">
                            <div class="template-img">
                                <img src="{{ asset('site/img/template-img1.jpg') }}" alt="image">
                            </div><!--template-->
                        </div><!--col-->
                        <div class="col-sm-4">
                            <div class="template-img active">
                                <img src="{{ asset('site/img/template-img2.jpg') }}" alt="image">
                            </div><!--template-->
                        </div><!--col-->
                        <div class="col-sm-4">
                            <div class="template-img">
                                <img src="{{ asset('site/img/template-img3.jpg') }}" alt="image">
                            </div><!--template-->
                        </div><!--col-->
                    </div><!--row-->
                </div><!--form group-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="accreditation_no" type="text" class="form-control" placeholder="أدخل اسم المدرب">
                        </div><!--form group-->
                    </div><!--col-->
                </div><!--row-->

                <div class="form-group">
                    <label for="trainer_cv">
                        نبذة تعريفية عن المدرب\ة(إختياري)
                    </label>
                    <textarea class="form-control" name="trainer_cv" id="trainer_cv" cols="30" rows="10"
                ...
                <div class="form-group">
                    ...
                    <input id="hours_no" type="text" class="form-control" placeholder="مثال : 25">
                </div><!--form group-->
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <select id="show_time" class="select-css">
                                <option value="1">مثال : مفهوم القيادة</option>
                                <option value="2">مثال : مفهوم القيادة</option>
                            </select>
                        </div><!--col-->
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                <input type="text" class="form-control" placeholder="مثال : ٩ صباحاً">
                                <button type="button" class="plus-button">
                                    <img src="{{ asset('site/img/plus-circle.svg') }}" alt="image">
                                </button>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="price" type="text" class="form-control" placeholder="مثال: 140">
                        </div><!--form group-->
                    </div><!--col-->
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="form-group">
                    <label for="inquiry-number">
                        رقم الاستفسار في الإعلان
                        <span class="text-red">*</span>
                    </label>
                    <input id="inquiry-number" type="text" class="form-control"
                           placeholder="أدخل رقم الاتصال بالمدرب/ة">
                </div><!--form group-->
                ...
                <div class="form-group">
                    ...
                    <div class="group-inputs">
                        <label class="radio-form">
                        <span class="radio-style">
                            <input type="radio" class="radio-input" name="language">
                            <span></span>
                        </span>
                            <span class="radio-text">رجال</span>
                        </label>
                        ...
                        <span class="radio-style">
                            ...
                            <span class="radio-text">نساء</span>
                        </label>
                        ...
                        <span class="radio-style">
                            ...
                            <span class="radio-text">رجال ونساء</span>
                        </label>
                        ...
                        <span class="radio-style">
                            ...
                            <span class="radio-text">بدونء</span>
                        </label>
                        ...
                        <span class="radio-style">
                            ...
                            <span class="radio-text">آخرون</span>
                        </label>
                    </div>
                </div><!--form group-->
